# Generated by Django 4.1.3 on 2023-02-21 16:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='women',
            name='cat',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='women.category', verbose_name='Id категории'),
        ),
        migrations.AlterField(
            model_name='women',
            name='content',
            field=models.TextField(blank=True, verbose_name='Текст замечательной статьи'),
        ),
        migrations.AlterField(
            model_name='women',
            name='is_published',
        ...
        migrations.AlterField(
            model_name='women',
            name='photo',
            field=models.ImageField(upload_to='photos/%Y/%m/%d/', verbose_name='Красивая фотография'),
        ),
        migrations.AlterField(
            model_name='women',
            name='time_create',
        ...
        migrations.AlterField(
            model_name='women',
            name='title',
            field=models.CharField(max_length=255, verbose_name='Чудесный заголовок'),
        ),
    ]
